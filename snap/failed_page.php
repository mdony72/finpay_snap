        ...
        <div class="row">
            <div class="col-12">
                <div style="padding:20px;margin-top:50px;">
                    <center>
                        <h3>Opppss...</h3><br>
                        <img src="src/failed.png" style="width:300px;"><br><br>
                        <span>Pembayaran Anda gagal kami terima. Cek kembali transaksi Anda</span>
                        <!--<br><br><br>-->
                        <!--<button type="button" class="btn btn-danger" data-bs-dismiss="modal">Sudah menyelesaikan pembayaran?</button>-->
                    </center>
                </div>
            </div>
        </div>
